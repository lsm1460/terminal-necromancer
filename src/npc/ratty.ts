...
async function handleThreat(context: GameContext) {
  const dialogues = [
    ...
    '래티: "군대는 커녕 당장 네 코앞에 들이닥칠 쥐새끼 한 마리도 못 잡아서 쩔쩔매게 생겼는데? 꼴을 좀 봐, 그 넝마 같은 옷이 제법 잘 어울려."',
    '래티: "예전에는 좀 잘 나갔을지 몰라도, 여기선 네놈이 부리던 노예보다 못한 처지라고. 알아? 사신 놈 앞바닥이나 핥으면서 연명하는 꼬락서니가 참 볼만해."',
