...
async function handleJoin(player: Player, npc: NPC, context: GameContext) {
  ...
  if (hasGolem) {
    ...
    dialogues.push(
      '마야: "사신 놈들이 하역장 골렘들을 영혼 감시용으로 쓰는 건 다 제드 그 인간 작품일 거야. 옛날엔 케인 대장이랑 같이 저항하더니, 이젠 영혼 조각 연구에 미쳐서 저쪽으로 붙어버렸지."',
      '마야: "그러니까 나중에 그 녀석들을 마주치면 가차 없이 박살 내버려! 그게 터미널에 저항하는 가장 멋진 방법이니까."',
