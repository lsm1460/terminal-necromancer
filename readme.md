## 0. 남은 작업 정리
 - 상점(아이템 구입, 판매)
    - 마야 -> 포션, 골렘 강화(기부금에 따라 해금), 데스나이트 강화(기부금에 따라 해금), 판매, 구입 시 기여도 증가
    - 케인 -> 용병 고용 (기부금에 따라 해금) 고용 시 기여도 증가
    - 용병 부활, npc 공격 시 factionHostility 수치 증가 (boolean -> number), 카르마 수치 증가
    - 기부금 납부, 장비 판매 시 factionHostility 수치 감소
 - 보스 몹
 - skills of BattleTarget and minions..
 - 클리어 여부 저장, 클리어 시 골렘 제작 스킬 획득, 데스나이트 획득 등 이벤트 추가
 - eva 수치 추가하기
 - 골렘 만들기
 - 데스나이트
    - 사신에게서 레벨업 가능
