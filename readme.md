...
- 장비 벗기 전 어픽스 벨리데이션 체크해야함
- 스킬 습득 시 요구 경험치 량 추가
- 전투 중 현재 상태 보기 기능 추가

- 사신에게서 골렘 해금 시 플레이어의 상태에 추가
- 사신에게서 일정 경험치를 주고 스켈레톤 최고치 갱신하기

- 지하 2층에서 레지스탕스 마을 입구 발견 이벤트 진행 후 엘리베이터에서 2.5층 레지스탕스 본부 선택 가능
- 상점(아이템 구입, 판매)
...
- 뼈 창, 뼈 폭풍 시전 메뉴에서 기대 데미지 출력하기
- 레어도가 높은 스켈레톤도 색상값 부여하기, 관련해서 라이브러리 적용 알아보기
- look에 인벤토리에 있는 것도 보도록 하기, 아이템 명에 비슷하면 노출하기
