...
- 진행 단계에 따라 에코, 제드, 마르코, 마야, 케인에게 대사 추가하기
  true_ending_key가 있다면 최종보스의 대사 추가 스탯 버프, 스킬 추가?
  ㄴ 신규 지역에서 다른 요소로 강화 ex 탈리스만 등으로 어픽스 추출 & 추가
  ㄴ 그러면 최종보스를 더 쉽게 잡고 강해진거 체감하기 좋지 않을까?

- scene변경 시 그 층의 분위기를 나타낼 이미지 출력하기
- 사운드 에셋 찾기

- 다크나이트 강화단계에 따라 스킬 부여 2단계 5단계에 스킬 추가..?
