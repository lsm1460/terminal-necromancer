...
스켈레톤 승급 -아공간 확보 후 동일 등급의 스켈레톤을 2개 이상 보유 시 획득 -확률로 등급 상승, 스탯 증가, 스킬 추가
...
지하5.5층 하수처리시설
Mj의 요청(리저드맨 청소) 수락 시 열림
숲 늪지 하수처리시설
포유류와 리저드맨 사이의 갈등
리저드맨 십부장은 다크나이트로 승격가능한 골격

- epic: affix 추가 중

그 때, 그 때 상점을 리롤하면 안될 거 같은데 어떻게 막아야 할까?
...
- 다크나이트의 생성
  체력이 200을 넘기는 스켈레톤이 있다면 다크나이트 임명 기능 해금
  체력이 200넘기는 스켈레톤 중 선택하여 승급시킴
  새롭게 임명 시 업그래이드 슬롯은 초기화됨
- 다크나이트 강화
