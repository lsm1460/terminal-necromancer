...
전투에서 대기(턴 넘기기)..를 만들어야할지도(적이 모두 은신인 경우 처리할 방법이 없을 수 있음)
아공간 만들어야함,
레지스탕스 조우 이벤트 만들어야함
젝스가 골렘 강화해준다고 사신이 말해줘야함
골렘 잡으면 나오는 드랍템 하나 만들어야함
골렘 클리어 후 골렘은 isAlive 상태 false로 바꿔주어야 함
사신은 골렘을 잡아서 화가 나있는 상태인데 어떻게 아무튼 잘 쓰라고 대사 짜야함
